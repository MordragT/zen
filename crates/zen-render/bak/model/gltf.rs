...
impl GltfBuilder {
    ...
    pub fn create_texture(
        ...
        let image_view = json::buffer::View {
            ...
            byte_length: USize64((self.buffer.len() + image_buffer_len) as u64),
            byte_offset: Some(USize64(self.buffer.len() as u64)),
            byte_stride: None,
            extensions: Default::default(),
            extras: Default::default(),
            name: None,
        ...
        self.root.buffers[0].byte_length.0 += image_buffer_len as u64;
    ...
    pub fn build_primitive(&mut self, mesh: ZenMesh) -> PrimitiveBuilder {
        ...
        let vertices_view = json::buffer::View {
            buffer: json::Index::new(0),
            byte_length: USize64((self.buffer.len() + vertices_buffer_len) as u64),
            byte_offset: Some(USize64(self.buffer.len() as u64)),
        ...
        self.root.buffers[0].byte_length.0 += vertices_buffer_len as u64;
        ...
        let indices_view = json::buffer::View {
            buffer: json::Index::new(0),
            byte_length: USize64((self.buffer.len() + indices_buffer_len) as u64),
            byte_offset: Some(USize64(self.buffer.len() as u64)),
            byte_stride: None,
            extensions: Default::default(),
            extras: Default::default(),
        ...
        let tex_coords = json::Accessor {
            buffer_view: Some(vertices_view_index),
            byte_offset: Some(USize64((6 * mem::size_of::<f32>()) as u64)),
            count: USize64(num_elements),
            component_type: Valid(json::accessor::GenericComponentType(
                json::accessor::ComponentType::F32,
            )),
        ...
        let indices_accessor = json::Accessor {
            ...
            byte_offset: Some(USize64(0)),
            count: USize64(indices_len as u64),
            component_type: Valid(json::accessor::GenericComponentType(
